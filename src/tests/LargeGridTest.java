...
public final class LargeGridTest{
	...
	public static void main(String[] args){		
		...
		grid.changeLocation(0,0,0);
		grid.changeLocation(0,1,0);
		grid.changeLocation(0,3,2);
		grid.changeLocation(0,4,0);
		grid.changeLocation(0,5,0);
		grid.changeLocation(0,7,2);
		grid.changeLocation(0,8,0);
		grid.changeLocation(0,9,0);
		grid.changeLocation(0,11,2);
		grid.changeLocation(0,12,0);
		grid.changeLocation(0,13,0);
		grid.changeLocation(0,15,2);
		grid.changeLocation(0,16,0);
		grid.changeLocation(0,17,0);
		grid.changeLocation(0,19,2);
		grid.changeLocation(0,20,0);
		grid.changeLocation(0,21,0);
		grid.changeLocation(0,23,2);
		grid.changeLocation(0,24,0);
		grid.changeLocation(0,25,0);
		grid.changeLocation(0,27,2);
		grid.changeLocation(0,28,0);
		grid.changeLocation(0,29,0);
		grid.changeLocation(0,31,2);
		grid.changeLocation(0,32,0);
		grid.changeLocation(0,33,0);
		grid.changeLocation(0,35,2);
		grid.changeLocation(0,36,0);
		grid.changeLocation(0,37,0);
		grid.changeLocation(0,39,2);
		grid.changeLocation(0,40,0);
		grid.changeLocation(0,41,0);
		grid.changeLocation(0,43,2);
		grid.changeLocation(0,44,0);
		grid.changeLocation(0,45,0);
		grid.changeLocation(0,47,2);
